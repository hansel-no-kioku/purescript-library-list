...
| purescript-audiograph | 0.2.1 | ✔ | [0.2.1](https://pursuit.purescript.org/packages/purescript-audiograph) |
...
| purescript-bucketchain-health | 0.2.0 | ✔ | [0.2.0](https://pursuit.purescript.org/packages/purescript-bucketchain-health) |
...
| purescript-const | 4.1.0 | ✔ | [4.1.0](https://pursuit.purescript.org/packages/purescript-const) |
...
| purescript-expect-inferred | 0.2.0 | ✔ | [0.2.0](https://pursuit.purescript.org/packages/purescript-expect-inferred) |
...
| purescript-functor-vector | 0.1.0 |  | [0.1.0](https://pursuit.purescript.org/packages/purescript-functor-vector) |
...
| purescript-heap | 0.1.0 |  | [0.1.0](https://pursuit.purescript.org/packages/purescript-heap) |
...
| purescript-intertwine | 0.1.2 | ✔ | [0.1.2](https://pursuit.purescript.org/packages/purescript-intertwine) |
...
| purescript-lenient-html-parser | 4.0.0 | ✔ | [4.0.0](https://pursuit.purescript.org/packages/purescript-lenient-html-parser) |
...
| purescript-modules | 3.0.0 |  | [5.0.0](https://pursuit.purescript.org/packages/purescript-modules) |
...
| purescript-node-stream-buffers | 0.1.1 |  | [0.1.1](https://pursuit.purescript.org/packages/purescript-node-stream-buffers) |
...
| purescript-paxl | 0.0.2 |  | [0.0.2](https://pursuit.purescript.org/packages/purescript-paxl) |
...
| purescript-purescript-compiler-backend-utilities | 0.0.1 |  | [0.0.1](https://pursuit.purescript.org/packages/purescript-purescript-compiler-backend-utilities) |
...
| purescript-react-redux | 6.1.0 |  | [6.1.0](https://pursuit.purescript.org/packages/purescript-react-redux) |
...
| purescript-rx-observable | 0.3.1 |  | [1.1.3](https://pursuit.purescript.org/packages/purescript-rx-observable) |
...
| purescript-smash | 3.0.0 | ✔ | [3.0.0](https://pursuit.purescript.org/packages/purescript-smash) |
...
| purescript-strongcheck | 4.1.1 | ✔ | [4.1.1](https://pursuit.purescript.org/packages/purescript-strongcheck) |
...
| purescript-trout-client | 0.10.0 |  | [0.10.0](https://pursuit.purescript.org/packages/purescript-trout-client) |
...
| purescript-vega | 1.0.0 | ✔ | [1.0.0](https://pursuit.purescript.org/packages/purescript-vega) |
| purescript-verbal-expressions | 4.0.0 | ✔ | [4.0.0](https://pursuit.purescript.org/packages/purescript-verbal-expressions) |
| purescript-versions | 5.0.0 | ✔ | [5.0.0](https://pursuit.purescript.org/packages/purescript-versions) |
| purescript-vexflow | 0.1.0 | ✔ | [0.1.0](https://pursuit.purescript.org/packages/purescript-vexflow) |
| purescript-vnm-utility | 3.0.0 | ✔ | [3.0.0](https://pursuit.purescript.org/packages/purescript-vnm-utility) |
| purescript-vom | 1.6.0 |  | [1.6.0](https://pursuit.purescript.org/packages/purescript-vom) |
| purescript-web-clipboard | 1.0.0 | ✔ | [1.0.0](https://pursuit.purescript.org/packages/purescript-web-clipboard) |
| purescript-web-dom | 1.0.0 | ✔ | [1.0.0](https://pursuit.purescript.org/packages/purescript-web-dom) |
| purescript-web-events | 1.0.1 | ✔ | [1.0.1](https://pursuit.purescript.org/packages/purescript-web-events) |
| purescript-web-file | 1.1.0 | ✔ | [1.1.0](https://pursuit.purescript.org/packages/purescript-web-file) |
| purescript-web-html | 1.2.0 | ✔ | [1.2.0](https://pursuit.purescript.org/packages/purescript-web-html) |
| purescript-web-socket | 1.0.0 | ✔ | [1.0.0](https://pursuit.purescript.org/packages/purescript-web-socket) |
| purescript-web-storage | 2.0.0 | ✔ | [2.0.0](https://pursuit.purescript.org/packages/purescript-web-storage) |
| purescript-web-touchevents | 1.0.0 | ✔ | [1.0.0](https://pursuit.purescript.org/packages/purescript-web-touchevents) |
| purescript-web-uievents | 1.1.0 | ✔ | [1.1.0](https://pursuit.purescript.org/packages/purescript-web-uievents) |
| purescript-web-xhr | 2.0.0 | ✔ | [2.0.0](https://pursuit.purescript.org/packages/purescript-web-xhr) |
| purescript-web3 | 1.0.0 | ✔ | [0.25.1](https://pursuit.purescript.org/packages/purescript-web3) |
| purescript-web3-generator | 1.0.0 | ✔ | [0.18.0](https://pursuit.purescript.org/packages/purescript-web3-generator) |
| purescript-webaudio | 0.1.2 | ✔ | [0.1.2](https://pursuit.purescript.org/packages/purescript-webaudio) |
| purescript-webcomponents | 0.1.0 |  | [0.1.0](https://pursuit.purescript.org/packages/purescript-webcomponents) |
| purescript-webdriver | 6.0.0 | ✔ | [4.0.1](https://pursuit.purescript.org/packages/purescript-webdriver) |
| purescript-weber | 0.1.4 | ✔ | [0.1.4](https://pursuit.purescript.org/packages/purescript-weber) |
| purescript-webgl | 2.0.1 |  | [2.0.1](https://pursuit.purescript.org/packages/purescript-webgl) |
| purescript-webgl2-raw | 1.0.0 | ✔ | [1.0.0](https://pursuit.purescript.org/packages/purescript-webgl2-raw) |
| purescript-webidl | 3.0.0 | ✔ | [3.0.0](https://pursuit.purescript.org/packages/purescript-webidl) |
| purescript-websocket-moderate | 4.0.0 | ✔ | [4.0.0](https://pursuit.purescript.org/packages/purescript-websocket-moderate) |
| purescript-websocket-simple | 2.0.0 |  | [2.0.0](https://pursuit.purescript.org/packages/purescript-websocket-simple) |
| purescript-webstorage | 4.0.0 |  | [4.0.0](https://pursuit.purescript.org/packages/purescript-webstorage) |
| purescript-wechaty | 1.0.1 |  | [1.0.1](https://pursuit.purescript.org/packages/purescript-wechaty) |
| purescript-with-index | 2.0.0 |  | [2.0.0](https://pursuit.purescript.org/packages/purescript-with-index) |
| purescript-word | 0.4.1 |  | [0.4.1](https://pursuit.purescript.org/packages/purescript-word) |
| purescript-workers | 2.1.0 |  | [2.1.0](https://pursuit.purescript.org/packages/purescript-workers) |
| purescript-wrappable | 1.0.0 |  | [1.0.0](https://pursuit.purescript.org/packages/purescript-wrappable) |
| purescript-ws | 0.0.2 |  | [0.0.2](https://pursuit.purescript.org/packages/purescript-ws) |
| purescript-xiaomian | 0.1.0 | ✔ | [0.1.0](https://pursuit.purescript.org/packages/purescript-xiaomian) |
| purescript-xorshift | 3.0.1 |  | [3.0.1](https://pursuit.purescript.org/packages/purescript-xorshift) |
| purescript-xstream | 1.0.0 |  | [1.0.0](https://pursuit.purescript.org/packages/purescript-xstream) |
